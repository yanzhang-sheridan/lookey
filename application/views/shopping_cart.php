  ...
  <div class="table-responsive">
   ...
   foreach($product as $row)
   {
    ...
    <div class="col-md-4" style="padding:16px; background-color:#f1f1f1; border:1px solid #ccc; margin-bottom:16px; height:400px" align="center">
     <img src="'.base_url().'asset/image/'.$row->product_image.'" class="img-thumbnail" /><br />
 ...
 $('.add_cart').click(function(){
  ...
  if(quantity != '' && quantity > 0)
  {
   ...
   $.ajax({
    ...
    url:"http://localhost/CodeIgniter/shopping_cart/add", 
    //<?php //echo base_url(); ?>shopping_cart/add",
  ...
  $('#cart_details').load("http://localhost/CodeIgniter/shopping_cart/load");
